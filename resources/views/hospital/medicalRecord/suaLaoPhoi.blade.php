                        ...
                        <p><strong>{{$i+1}}.{{$que['text']}}</strong></p>
                            ...
                            <label class="radio-inline">
                                <input name="hoiBenh{{$i}}" value="ChuaChon"
                                       type="radio" <?php echo ($record['hoiBenh'][$i]['answer'] == "Chưa chọn") ? 'checked=""' : '';?>>Chưa chọn
                            </label>
                    @endforeach

                    <h3>III.Bệnh sử</h3>
                    <textarea class="form-control" name="benhSu"
                              style="height: 100px; width: 500px;">{{$record['benhSu']}}</textarea>
                    <br>
                    <div align="center">
                        <br>
                        <a>
                ...
                <div id="page-wrapper">
                    ...
                    @foreach($question['chuanDoan']['lamSang'] as $i => $que)
                        <p><strong>{{$que['_id']}}.{{$que['text']}}</strong></p>
                            <label class="radio-inline">
                                <input name="lamSang{{$i}}" value="Co"
                                       type="radio" <?php echo ($record['chuanDoan']['lamSang'][$i]['answer'] == "Có") ? 'checked=""' : '';?>>Có
                            </label>
                            <label class="radio-inline">
                                <input name="lamSang{{$i}}" value="Khong"
                                       type="radio" <?php echo ($record['chuanDoan']['lamSang'][$i]['answer'] == "Không") ? 'checked=""' : '';?>>Không
                            </label>
                            <label class="radio-inline">
                                <input name="lamSang{{$i}}" value="ChuaChon"
                                       type="radio" <?php echo ($record['chuanDoan']['lamSang'][$i]['answer'] == "Chưa chọn") ? 'checked=""' : '';?>>Chưa chọn
                            </label>
                    @endforeach
                    ...
                    @foreach($question['chuanDoan']['canLamSang'] as $i => $que)
                        <p><strong>{{$que['_id']}}.{{$que['text']}}</strong></p>
                            <label class="radio-inline">
                                <input name="canLs{{$i}}" value="Co"
                                       type="radio" <?php echo ($record['chuanDoan']['canLamSang'][$i]['answer'] == "Có") ? 'checked=""' : '';?>>Có
                            </label>
                            <label class="radio-inline">
                                <input name="canLs{{$i}}" value="Khong"
                                       type="radio" <?php echo ($record['chuanDoan']['canLamSang'][$i]['answer'] == "Không") ? 'checked=""' : '';?>>Không
                            </label>
                            <label class="radio-inline">
                                <input name="canLs{{$i}}" value="ChuaChon"
                                       type="radio" <?php echo ($record['chuanDoan']['canLamSang'][$i]['answer'] == "Chưa chọn") ? 'checked=""' : '';?>>Chưa chọn
                            </label>
                    @endforeach

                    <h3>V.Chuẩn đoán xác định</h3>
                    <textarea class="form-control" name="xacDinh"
                              style="height: 100px; width: 500px;">{{$record['chuanDoanXacDinh']}}</textarea><br><br><br>
                    <div align="center">
                        <a>
